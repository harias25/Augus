...
def p_etiquetas_lista(t) :
    ...
    gramatical = G.ValorAscendente('etiquetas -> etiquetas etiqueta','etiquetas.lista = [etiqueta]; </hr> etiquetas.lista = etiquetas.lista + etiquetas1.lista;',lista)
    func(0,gramatical)
...
def p_etiqueta(t) :
    ...
    if(not band(0,True)):
        ...
        gramatical2 = G.ValorAscendente('instrucciones -> epsilon','instrucciones.lista = []',list2)
        func(0,gramatical2)
        band(1,True)
...
def p_instrucciones_lista(t) :
    ...
    t[0] = t[0] + t[2]
    lista = func(1,None).copy()
    gramatical = G.ValorAscendente('instrucciones -> instruccion instrucciones ','instrucciones.lista = [instruccion]; </hr> instrucciones.lista = instrucciones.lista  + instrucciones1.lista;',lista)
...
def p_instrucciones_instruccion(t) :
    ...
    t[0] = []
    #lista = func(1,None).copy()
    gramatical = G.ValorAscendente('instrucciones -> epsilon','instrucciones.lista = []',[])
