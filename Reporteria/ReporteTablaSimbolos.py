...
class ReporteTablaSimbolos():
    ...
    def generarReporte(self,ent,arbol):
        ...
        contenido = contenido + "<TH  style=\"font-size: 18px; width:20%; color:white\" align=center>Tipo de Dato</TH>" + '\n'
        contenido = contenido + "<TH  style=\"font-size: 18px; width:30%; color:white\" align=center>Nombre</TH>" + '\n'
        contenido = contenido + "<TH  style=\"font-size: 18px; width:20%; color:white\" align=center>Valor</TH>" + '\n'
        contenido = contenido + "<TH  style=\"font-size: 18px; width:15%; color:white\" align=center>Linea</TH>" + '\n'
        contenido = contenido + "<TH  style=\"font-size: 18px; width:15%; color:white\" align=center>Columna</TH>" + '\n'
